...
class Dataset:
    ...
    def __init__(self, batch_size, max_len):
        ...
        - update the data_train attribute by performing the following actions:
          * filter out all examples that have either sentence with
        ...
        - update the data_validate attribute by performing
            the following actions:
          * filter out all examples that have either sentence with
              more than max_len tokens
          * split the dataset into padded batches of size batch_size
        """
        pt2en, info = tfds.load(
        ...
        def filter(x, y, max_len=max_len):
            """
            filter out all examples that have either
        ...
        self.data_train = self.data_train.paded_batch(batch_size,
        ...
        self.data_valid = self.data_valid.paded_batch(batch_size,
                                                      padded_shapes=padding)
